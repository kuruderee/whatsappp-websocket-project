...
public class CallService {
    ...
    public Call startCall(String initiatorUsername, String recipientUsername) {
        if (initiatorUsername == null || recipientUsername == null) {
            System.out.println("Caller ve Receiver bilgileri eksik!");
        ...
        try {
            ...
            System.out.println("Veritabanına kaydedilen çağrı: {}"+ call);
        } catch (Exception e) {
            System.out.println("Çağrı kaydedilirken hata oluştu: {}"+ e.getMessage());
    ...
    public void saveCall(Call call) {
        System.out.println("Saving call: {}"+ call);
        callRepository.save(call);
    }
}
